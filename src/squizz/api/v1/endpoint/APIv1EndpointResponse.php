<?php
	...
	*/
	class APIv1EndpointResponse extends ESDocument
	{
		...
		const ENDPOINT_RESULT_CODE_ERROR_NO_CUSTOMER_ACCOUNT_FOUND = "SERVER_ERROR_NO_CUSTOMER_ACCOUNT_FOUND";
		const ENDPOINT_RESULT_CODE_ERROR_ORDER_PRODUCT_NOT_MATCHED = "SERVER_ERROR_ORDER_PRODUCT_NOT_MATCHED";
		const ENDPOINT_RESULT_CODE_ERROR_ORDER_LINE_PRICING_MISSING = "SERVER_ERROR_ORDER_LINE_PRICING_MISSING";
		const ENDPOINT_RESULT_CODE_ERROR_ORDER_SURCHARGE_NOT_FOUND = "SERVER_ERROR_ORDER_SURCHARGE_NOT_FOUND";
		const ENDPOINT_RESULT_CODE_ERROR_ORDER_SURCHARGE_PRICING_MISSING = "SERVER_ERROR_ORDER_SURCHARGE_PRICING_MISSING";
		const ENDPOINT_RESULT_CODE_ERROR_ORDER_PAYMENT_NOT_MATCHED = "SERVER_ERROR_ORDER_PAYMENT_NOT_MATCHED";
		const ENDPOINT_RESULT_CODE_ERROR_PAYMENT_STATUS_NOT_SUPPORTED = "SERVER_ERROR_PAYMENT_STATUS_NOT_SUPPORTED";
