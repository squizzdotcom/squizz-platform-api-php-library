					...
					if($apiOrgSession->sessionExists())
					{
						...
						if($result=="SUCCESS")
						{
							...
							while($getMoreRecords)
							{
								...
								$endpointResponseESD = APIv1EndpointOrgRetrieveESDocument::call($apiOrgSession, $timeoutMilliseconds, APIv1EndpointOrgRetrieveESDocument::RETRIEVE_TYPE_ID_PRODUCT_IMAGE, $supplierOrgID, '',$recordsMaxAmount, $recordsStartIndex);
								$getMoreRecords = false;
								$esDocument = $endpointResponseESD->esDocument;
